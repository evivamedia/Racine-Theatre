...
?>
	...
	<tr><td valign="top"><label for="image_alt"><?php _e( 'Image Alt Attribute', 'it-l10n-Builder' ); ?></label></td>
		<td>
			<?php $form->add_text_box( 'image_alt' ); ?>
			<?php ITUtility::add_tooltip( __( 'This sets the <code>alt</code> attribute of the <code>img</code> tag. This attribute is typically used to describe the image in case it cannot be viewed. If this is left blank, the Module\'s Name will be used instead.', 'it-l10n-Builder' ) ); ?>
		</td>
	</tr>
	<tr><td valign="top"><label for="url"><?php _e( 'Link URL', 'it-l10n-Builder' ); ?></label></td>
		<td>
	...
	<tr><td valign="top"><label for="new_window"><?php _e( 'Link Opens New Window', 'it-l10n-Builder' ); ?></label></td>
		<td>
