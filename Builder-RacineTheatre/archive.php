					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="entry-header clearfix">
							...
							<div class="alignright">
								<div class="vc_btn3-container vc_btn3-left vc_custom_1457781165496"><a class="vc_general vc_btn3 vc_btn3-size-xs vc_btn3-shape-square vc_btn3-style-outline vc_btn3-icon-left vc_btn3-color-black" href="<?php the_permalink(); ?>" title="" target="_self"><i class="vc_btn3-icon fa fa-plus"></i> VIEW</a></div>
							</div>
						</div>
